...
module("Unit | Utility | chart", function () {
  ...
  test("shapeData shapes data to chart readable content", function (assert) {
    ...
    assert.deepEqual(
      ...
      {
        labels: ["12/31/18", "01/01/19", "01/02/19"],
        series: [
          [1.355, 1.569, 2.576],
          ["a", "a", "c"],
        ],
    ...
    assert.deepEqual(
      ...
      {
        labels: ["01/01/19", "01/02/19", "01/03/19"],
        series: [
          [1.569, 2.576, 3.874],
          ["a", "c", "b"],
        ],
    ...
    assert.deepEqual(
      ...
      {
        labels: ["01/06/19", "01/07/19", "01/08/19", "01/09/19"],
        series: [
  ...
  test("dateToISO changes date strings successfully", function (assert) {
    assert.strictEqual(
      dateToISO(new Date("2018-12-31")),
      "2018-12-31",
      "Successfully changes date string back to ISO"
    );
  });
});
